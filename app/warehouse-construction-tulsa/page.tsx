...
export const metadata: Metadata = {
    title: "Warehouse Construction Tulsa OK | Distribution",
    description: "Tulsa warehouse construction company. Clear-span warehouses from 10,000 to 200,000+ SF — pre-engineered metal, dock-high loading, ESFR sprinklers.",
    openGraph: { images: [{ url: "https://www.udgok.com/images/og-default.png", width: 1200, height: 630, alt: "UDGOK — Medical & Dental Design-Build Construction in Tulsa, Oklahoma" }], title: "Warehouse Construction Tulsa OK | UDGOK", description: "Clear-span warehouses and distribution centers from 10,000 to 200,000+ SF in Tulsa, Oklahoma.", url: "https://www.udgok.com/warehouse-construction-tulsa" },
  ...
  return (
      ...
      <FAQJsonLd questions={PAGE_FAQS} /><ServiceJsonLd name="Warehouse Construction Tulsa" description="Tulsa warehouse construction — clear-span warehouses, distribution centers, and PEMB warehouse buildings from 10,000 to 200,000+ SF." url="https://www.udgok.com/warehouse-construction-tulsa" />
            <ServicePage
                ...
                imageSrc="/images/warehouse-construction-hero.png"
                ...
                intro="Tulsa's industrial vacancy rate is at historic lows, driving record demand for new warehouse and distribution space. UDGOK is the Tulsa metro's most experienced warehouse contractor — we build everything from 10,000 SF flex warehouses to 200,000+ SF cross-dock distribution facilities. Our <a href='/pre-engineered-metal-buildings-tulsa'>pre-engineered metal building (PEMB)</a> partnerships deliver turnkey shells 30% faster than conventional steel, and our <a href='/design-build'>design-build delivery</a> eliminates the gaps between architect, engineer, and contractor. See our <a href='/guide-pemb-vs-steel-oklahoma'>PEMB vs conventional steel comparison</a> to find the right structural system for your project."
                stats={[

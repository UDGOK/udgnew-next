...
export const metadata: Metadata = {
  ...
  description: "UDGOK specializes in building modern dental offices in Bixby, Oklahoma. Expert construction for general, pediatric, orthodontic.",
  openGraph: {
  ...
  alternates: { canonical: "https://www.udgok.com/bixby-dental-construction" },
};
...
export default function BixbyDentalPage() {
  ...
  const PAGE_BREADCRUMBS = [
    ...
    { name: "Dental Office Construction in Bixby", url: "https://www.udgok.com/bixby-dental-construction" }
  ];
  const PAGE_FAQS = [
